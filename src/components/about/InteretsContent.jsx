export default function InteretsContent() {
  return (
    <div className="markdown-content text-text-default">
      <h1 className="text-blue-html text-xl max-[426px]:text-lg font-semibold mb-4">Les passions d'un développeur junior</h1>
      
      <h2 className="text-blue-html text-lg max-[426px]:text-base font-semibold mt-6 mb-3">Le code comme nouvelle partition</h2>
      ...
      <p className="mb-4 max-[426px]:text-sm">Le HTML et le CSS sont mes nouveaux instruments de base, JavaScript mon amplificateur, et React et Tailwind mes pédales d'effets préférées.</p>
      
      <h2 className="text-blue-html text-lg max-[426px]:text-base font-semibold mt-6 mb-3">Veille technologique : ma nouvelle playlist</h2>
      
      <p className="mb-4 max-[426px]:text-sm">Autrefois, je passais des heures à découvrir de nouveaux groupes et albums. Aujourd'hui, je fais défiler les articles techniques et tutoriels avec la même avidité.</p>
      
      <p className="mb-4 max-[426px]:text-sm">Ma liste de lecture ne contient plus des titres d'albums mais des noms de frameworks, mes artistes préférés sont devenus des développeurs partageant leur expertise. Même passion, nouveau médium.</p>
      
      <h2 className="text-blue-html text-lg max-[426px]:text-base font-semibold mt-6 mb-3">L'exploration au-delà du code</h2>
