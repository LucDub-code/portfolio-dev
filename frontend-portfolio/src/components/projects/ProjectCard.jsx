    ...
    <div className="bg-bg-terminal border border-border-ide text-text-default rounded-lg overflow-hidden w-80 h-96 max-[1280px]:w-64 max-[1280px]:h-80 flex flex-col">
      ...
      <div className="flex-1 p-4 max-[1280px]:p-3">
        ...
        <div className="flex justify-around">
          <button className="bg-text-default text-bg-terminal px-4 py-2 max-[1280px]:px-3 max-[1280px]:py-1.5 max-[1280px]:text-sm rounded-lg cursor-pointer flex items-center gap-2 max-[1280px]:gap-1.5">
            Le projet
            <img
          ...
          <button className="bg-text-default text-bg-terminal px-4 py-2 max-[1280px]:px-3 max-[1280px]:py-1.5 max-[1280px]:text-sm rounded-lg flex items-center gap-2 max-[1280px]:gap-1.5 cursor-pointer">
            Le code
            <img
              src={githubIcon}
              alt="GitHub"
