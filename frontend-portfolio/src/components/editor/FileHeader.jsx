...
export default function FileHeader() {
  ...
  return (
    <div className="flex items-center pt-1 pb-1 px-2 text-text-default text-xs max-[425px]:text-[0.7rem] max-[380px]:text-[0.625rem] max-[320px]:text-[0.5rem] max-[425px]:text-sm bg-bg-ui w-full border-b border-border-ide tracking-wide">
      <span className="mr-1 text-gray-inactive">&gt;</span>
      {currentPage && (
