      ...
      <div className="flex-1 flex items-center justify-center max-[769px]:items-start max-[769px]:pt-8">
        <div className="flex flex-col items-center">
          ...
          <div className="text-center">
            <div className="text-green-comment mb-2 max-[376px]:text-[0.625rem] max-[321px]:text-[0.55rem]">
              // Projets en cours de développement...
            </div>
            <div className="text-green-comment mb-4 max-[376px]:text-[0.625rem] max-[321px]:text-[0.55rem] max-[321px]:px-2">
              // De nouvelles créations seront déployées prochainement !
            </div>
          </div>
        </div>
      </div>
